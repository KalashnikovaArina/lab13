...
int main()
{
    ...
    // load models
    // -----------    
    Model planet("resources/10014_dolphin_v1_L3.123c87c4405d-8340-49e7-9aac-bec76c253dc0/10014_dolphin_v2_max2011_it2.obj");
    Model rock("resources/Blue-Green_Reef_Chromis_v2_L3.123c119e966e-6768-4592-92ac-96b676247267/13007_Blue-Green_Reef_Chromis_v2_l3.obj");
    ...
    for (unsigned int i = 0; i < amount; i++)
    {
        ...
        float y = displacement * 0.4f + 1.0f; // keep height of asteroid field smaller compared to width of x and z
        displacement = (rand() % (int)(2 * offset * 100)) / 100.0f - offset;
        float z = cos(angle) * radius + displacement;
        model = glm::translate(model, glm::vec3(x, y, z));

        // 2. scale: Scale between 0.05 and 0.25f
        float scale = static_cast<float>((rand() % 20) / 100.0 + 2.05);
